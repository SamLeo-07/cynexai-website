  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen pt-20 flex items-center justify-center bg-[#FFFFFF]">
        ...
        >
          <div className="bg-[#FFFFFF] text-[#010203] rounded-2xl p-8 border border-[#376db0]/20 text-center">
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{ delay: 0.2, type: 'spring', stiffness: 200 }}
              className="w-16 h-16 bg-[#376db0] rounded-full flex items-center justify-center mx-auto mb-6"
            >
              <CheckCircle className="w-8 h-8 text-white" />
            </motion.div>
            <h1 className="text-2xl font-bold mb-4">Thank You for Applying!</h1>
            <p className="text-[#010203]/80 mb-6">
              Your application for <span className="text-[#376db0] font-medium">{courseName}</span> has been submitted successfully. Our team will review your application and contact you within 24-48 hours.
            </p>
            <div className="space-y-3 mb-8 text-[#010203]/80">
              ...
              <div className="flex items-center justify-between text-sm">
                <span>Status:</span>
                <span className="text-[#376db0] font-medium">Under Review</span>
              </div>
            </div>
            <div className="space-y-3">
              <Link
                to="/"
                className="w-full bg-[#376db0] text-white py-3 px-4 rounded-lg font-medium block text-center hover:bg-[#c09a2f] transition-colors duration-300"
              >
                Back to Home
              </Link>
              <Link
                to={`/course/${courseId}`}
                className="w-full border-2 border-[#376db0] text-[#010203] py-3 px-4 rounded-lg font-medium block text-center hover:bg-[#376db0]/10 transition-colors duration-300"
              >
                View Course Details
              </Link>
            </div>
    ...
    <div className="min-h-screen pt-20 bg-[#FFFFFF]">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <Link
            to={`/course/${courseId}`}
            className="inline-flex items-center text-[#376db0] hover:text-[#a3852c] transition-colors mb-6"
          >
            <ArrowLeft className="w-4 h-4 mr-2" />
            Back to Course
          </Link>
          <h1 className="text-3xl md:text-4xl font-display font-bold text-[#010203] mb-4">
            Apply for <span className="text-[#376db0]">{courseName}</span>
          </h1>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-[#FFFFFF] text-[#010203] rounded-2xl p-8 border border-[#376db0]/20">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-[#F5F5F5] border border-[#376db0]/20 rounded-lg text-[#010203] placeholder-[#010203]/50 focus:outline-none focus:ring-2 focus:ring-[#376db0]/20 transition-colors duration-300"
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                required
                className="w-full px-4 py-3 bg-[#F5F5F5] border border-[#376db0]/20 rounded-lg text-[#010203] focus:outline-none focus:ring-2 focus:ring-[#376db0]/20 transition-colors duration-300"
              >
                <option value="student" className="bg-[#FFFFFF]">Student</option>
                <option value="employed" className="bg-[#FFFFFF]">Employed</option>
              </select>
            </div>
            <div className="bg-[#376db0]/10 border border-[#376db0]/20 rounded-lg p-4">
            ...
            <motion.button
              ...
              className={`w-full py-4 px-6 rounded-lg font-semibold transition-colors duration-300 ${
                isLoading
                  ...
                  : 'bg-[#376db0] text-[#010203] hover:bg-[#c09a2f]'
              }`}
            >
              {isLoading ? (
          ...
          <div className="mt-8 p-4 bg-[#F5F5F5] rounded-lg border border-[#376db0]/20">
