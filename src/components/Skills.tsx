  ...
  const skills = [
    {
      ...
      color: 'from-[#376db0] to-amber-500', // Gold gradient for icons
      bgColor: 'bg-white', // Card background
      borderColor: 'border-[#376db0]/30', // Card border
    ...
    },
    {
      ...
      color: 'from-[#376db0] to-yellow-500',
      bgColor: 'bg-white',
      borderColor: 'border-[#376db0]/30',
    ...
    },
    {
      ...
      color: 'from-[#376db0] to-orange-500',
      bgColor: 'bg-white',
      borderColor: 'border-[#376db0]/30',
      titleColor: 'text-black',
      descriptionColor: 'text-gray-800',
    },
    {
      ...
      color: 'from-[#376db0] to-yellow-600',
      bgColor: 'bg-white',
      borderColor: 'border-[#376db0]/30',
      titleColor: 'text-black',
      descriptionColor: 'text-gray-800',
  ...
  return (
    <section id="skills" className="py-20 relative bg-white"> {/* Section background changed to white */}
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 -left-20 w-40 h-40 bg-[#376db0]/10 rounded-full blur-3xl"></div> {/* Gold tint */}
        <div className="absolute bottom-1/4 -right-20 w-60 h-60 bg-[#376db0]/10 rounded-full blur-3xl"></div> {/* Gold tint */}
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {skills.map((skill, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group ${skill.bgColor} rounded-2xl p-8 border ${skill.borderColor} hover:border-[#376db0]/60 transition-all duration-300 hover:shadow-xl text-center`} // Using skill.bgColor and skill.borderColor
              >
                ...
                <h3 className={`text-xl font-semibold ${skill.titleColor} mb-4 group-hover:text-[#376db0] transition-colors`}> {/* Dynamic title color, gold on hover */}
                  {skill.title}
                </h3>
        ...
        >
          <div className="bg-[#376db0]/10 rounded-3xl p-8 border border-[#376db0]/30 shadow-lg"> {/* Gold tinted background, gold border */}
            <h3 className="text-2xl font-semibold text-black mb-6"> {/* Text to black */}
              Why These Skills Matter
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              <div>
                <h4 className="text-lg font-medium text-[#376db0] mb-3">In the Workplace</h4> {/* Gold text */}
              ...
              <div>
                <h4 className="text-lg font-medium text-[#376db0] mb-3">For Career Growth</h4> {/* Gold text */}
                <p className="text-gray-800"> {/* Darker gray text */}
