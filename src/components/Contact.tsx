          ...
          >
            ...
            <form className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full bg-primary text-secondary hover:bg-primary-600 py-4 px-6 rounded-lg font-semibold hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 shadow-lg hover:shadow-purple-500/25"
              >
                Send Message
              </motion.button>
            </form>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
            ...
            <div className="bg-white/10 rounded-xl p-4 text-center">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center px-6 py-3 bg-primary text-secondary hover:bg-primary-600 rounded-lg font-medium hover:from-purple-700 hover:to-cyan-700 transition-all duration-300"
              >
