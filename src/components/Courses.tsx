...
const Courses = () => {
  ...
  const courses = [
    { id: 'data-science-ai', title: 'Data Science with AI', description: 'Master data analysis, machine learning algorithms, and AI implementation for real-world applications.', image: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800', duration: '6 months', students: '150+', rating: 4.9, level: 'Intermediate', skills: ['Python', 'TensorFlow', 'Pandas', 'Scikit-learn'] },
    { id: 'machine-learning', title: 'Machine Learning', description: 'Deep dive into ML algorithms, neural networks, and predictive modeling techniques.', image: 'https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg?auto=compress&cs=tinysrgb&w=800', duration: '4 months', students: '200+', rating: 4.8, level: 'Advanced', skills: ['Python', 'PyTorch', 'Keras', 'OpenCV'] },
    { id: 'llm-engineering', title: 'LLM Engineering', description: 'Build and deploy Large Language Models, understand transformers and modern NLP techniques.', image: 'https://images.pexels.com/photos/8386422/pexels-photo-8386422.jpeg?auto=compress&cs=tinysrgb&w=800', duration: '5 months', students: '80+', rating: 4.9, level: 'Expert', skills: ['Transformers', 'Hugging Face', 'BERT', 'GPT'] },
    { id: 'generative-ai', title: 'Generative AI', description: 'Create AI systems that generate content, from text to images using cutting-edge techniques.', image: 'https://images.pexels.com/photos/8386427/pexels-photo-8386427.jpeg?auto=compress&cs=tinysrgb&w=800', duration: '4 months', students: '120+', rating: 4.7, level: 'Advanced', skills: ['GANs', 'VAEs', 'Diffusion Models', 'DALL-E'] },
    { id: 'java-python', title: 'JAVA/Python', description: 'Master programming fundamentals with Java and Python for enterprise and AI development.', image: 'https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg?auto=compress&cs=tinysrgb&w=800', duration: '3 months', students: '300+', rating: 4.6, level: 'Beginner', skills: ['Java', 'Python', 'OOP', 'Data Structures'] },
    { id: 'devops-aws', title: 'DevOps/AWS', description: 'Learn cloud infrastructure, CI/CD pipelines, and deployment strategies on AWS.', image: 'https://images.pexels.com/photos/1181298/pexels-photo-1181298.jpeg?auto=compress&cs=tinysrgb&w=800', duration: '5 months', students: '180+', rating: 4.8, level: 'Intermediate', skills: ['AWS', 'Docker', 'Kubernetes', 'Jenkins'] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div ref={ref} variants={containerVariants} initial="hidden" animate={inView ? 'visible' : 'hidden'} className="text-center mb-16">
          <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-display font-bold mb-6">
            <span className="text-[#26abff]">Transform Your Skills</span>
          </motion.h2>
        ...
        <motion.div variants={containerVariants} initial="hidden" animate={inView ? 'visible' : 'hidden'} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {courses.map((course, index) => (
            <motion.div key={course.id} variants={itemVariants} whileHover={{ y: -10, scale: 1.02 }} className="group bg-gray-50 rounded-2xl overflow-hidden border border-gray-200 hover:border-[#26abff] transition-all duration-300 shadow-sm">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-4 text-sm text-gray-600">
                  ...
                  <div className="flex items-center">
                    <Star className="w-4 h-4 mr-1 text-[#26abff]" />{course.rating}
                  </div>
                </div>

                <div className="flex flex-wrap gap-2 mb-6">
                  {course.skills.slice(0, 3).map((skill, skillIndex) => (
                    <span key={skillIndex} className="px-2 py-1 bg-[#26abff]/10 text-[#26abff] rounded-md text-xs border border-[#26abff]/30">
                      {skill}
                    </span>
                  ))}
                ...
                <Link to={`/course/${course.id}`} className="w-full block bg-[#26abff] text-white py-3 px-4 rounded-lg font-medium text-center hover:bg-[#c09a2f] transition-colors duration-300 flex items-center justify-center">
                  Learn More
