  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-[#26abff]/95 backdrop-blur-md border-b border-[#26abff]/20'
          : 'bg-transparent'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center h-16 lg:h-20"> {/* Original compact height */}
            ...
            {navItems.map(({ name, href }) => {
              ...
              return (
                ...
                >
                  {name}
                  <span
                    className={`absolute -bottom-1 left-0 h-0.5 bg-[#26abff] transition-all duration-300 ${
          ...
          <button
            ...
            className={`lg:hidden p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-[#26abff] ${
              ...
              <div className="px-4 py-4 space-y-3">
                {navItems.map(({ name, href }) => (
                  <a
                    ...
                    className="block text-black hover:text-[#26abff] transition-colors duration-200 py-2 text-lg font-medium"
                  >
                    {name}
                  </a>
                ))}
